 ...
 */
package io.mosip.injicertify.config;
...
public class SecurityConfig {
    ...
    @Value("#{${mosip.injicertify.security.auth.post-urls}}")
    private Map<String, List<String>> securePostUrls;

    @Value("#{${mosip.injicertify.security.auth.put-urls}}")
    private Map<String, List<String>> securePutUrls;

    @Value("#{${mosip.injicertify.security.auth.get-urls}}")
    private Map<String, List<String>> secureGetUrls;

    @Value("${mosip.esignet.vci.authn.jwk-set-uri}")
    private String jwkSetUri;

    @Value("${mosip.injicertify.security.ignore-auth-urls}")
    private String[] ignoreAuthUrls;

    @Value("${mosip.injicertify.security.ignore-csrf-urls}")
