...
import io.mosip.injicertify.dto.vci.CredentialDefinition;
import io.mosip.injicertify.dto.vci.CredentialProof;
...
public class VCIssuanceControllerTest {
    ...
    public void test_getIssuerMetadata_thenPass() throws Exception {
        ...
        issuerMetadata.put("credential_endpoint", "https://localhost:9090/v1/inji-certify/vci/credential");
